...
import com.longyx.weixin.sell.utils.JsonUtil;
import com.longyx.weixin.sell.utils.MathUtil;
...
public class PayServiceImpl implements PayService {
    ...
    public PayResponse notify(String notifyData) {
        ...
        //判断订单是否存在
        if(orderDTO == null){
            log.error(" 【微信支付】 异步通知，该订单不存在， orderId = {}", payResponse.getOrderId());
        ...
        if(!MathUtil.equals(payResponse.getOrderAmount(), orderDTO.getOrderAmount().doubleValue())){
            ...
            throw new SellException(ResultEnum.WXPAY_ASYNC_PAY_NOTIFY_ERROR);
        }
